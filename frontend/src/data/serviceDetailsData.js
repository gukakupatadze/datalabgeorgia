...
export const SERVICE_DETAILS = {
    ...
    content: {
      ka: {
        ...
        seo: {
          ...
          description: 'HDD მონაცემთა აღდგენა თბილისში — ლოგიკური, მექანიკური და ელექტრონული დაზიანებები, წამკითხველი თავაკების შეცვლა, PCB, firmware, SMART და ლაბორატორიული სამუშაოები.'
        },
        ...
        processTitle: 'როგორ მიმდინარეობს HDD მონაცემთა აღდგენა',
        process: [
  ...
  'ssd-recovery': {
    ...
    content: {
      ka: {
        ...sharedKa,
        seo: { title: 'SSD მონაცემთა აღდგენა თბილისში | DataLab Georgia', description: 'SSD მონაცემთა აღდგენა თბილისში — SATA, M.2, NVMe, Controller, Firmware, NAND Flash, TRIM, ელექტრონული და ლოგიკური დაზიანებები.' },
        ...
        processTitle: 'როგორ მიმდინარეობს SSD მონაცემთა აღდგენა',
        process: [
  ...
  'raid-recovery': {
    ...
    content: {
      ka: {
        ...sharedKa,
        seo: { title: 'RAID და NAS მონაცემთა აღდგენა თბილისში | DataLab Georgia', description: 'RAID და NAS მონაცემთა აღდგენა თბილისში — RAID 0, RAID 1, RAID 5, RAID 6, RAID 10, degraded arrays, failed disks და RAID reconstruction.' },
        ...
        processTitle: 'როგორ მიმდინარეობს RAID/NAS მონაცემთა აღდგენა',
        process: [
  ...
  'usb-recovery': {
    ...
    content: {
      ka: {
        ...sharedKa,
        seo: { title: 'USB, SD და microSD მონაცემთა აღდგენა | DataLab Georgia', description: 'USB Flash, SD და microSD მონაცემთა აღდგენა თბილისში — წაშლილი ფოტოები, Format, Controller, NAND Flash, PCB და ფიზიკური დაზიანებები.' },
        ...
        processTitle: 'როგორ მიმდინარეობს USB / SD / microSD მონაცემთა აღდგენა',
        process: [
